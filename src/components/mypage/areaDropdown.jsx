...
const AreaDropdown = ({ dongCode, setDongCode, area, setArea }) => {
  ...
  return (
    <div className="flex w-full py-2 space-x-1 justify-evenly" ref={dropdownRef}>
      <div className="bg-primary-4 w-28 h-7 px-1 text-center rounded-xl items-center cursor-pointer">
        ...
        {dropdownView.city && (
          <ul className="bg-white h-32 overflow-auto custom-scrollbar border border-gray-2 mt-3 rounded-lg text-sm space-y-1 z-50 relative">
